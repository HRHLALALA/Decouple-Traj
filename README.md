**Note**: code is developed based on [GoalSAR](https://github.com/luigifilippochiara/Goal-SAR), aligned with [YNet](https://github.com/HarshayuGirase/Human-Path-Prediction/tree/master/ynet) settings. 
